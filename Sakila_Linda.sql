...
#2a. You need to find the ID number, first name, and last name of an actor from whom you know only the first name, "Joe." What is one query would you use to obtain this information?
SELECT * FROM actor
...
#4a_1 List the last names of actors as well as  howmany actors have that last name.
